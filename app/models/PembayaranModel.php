...

{
...

    {
        ...
        $stmt = $this->db->prepare(
            ...
            'SELECT jenis_kendaraan, total_dp, total_full, total_sisa

             FROM v_reservasi_harga WHERE id_reservasi = ?'
...

    {
        ...
        $stmt = $this->db->prepare(
            ...
            'INSERT INTO pembayaran_midtrans_pending

             (order_id, user_id, tipe, id_reservasi, layanan_ids, jenis_kendaraan, nominal, snap_token, status)
    ...
    public function buatPembayaranDpPending(
        ...
        $stmt = $this->db->prepare(
            ...
            'INSERT INTO pembayaran_dp (id_reservasi, nominal, status, metode_pembayaran, order_id, snap_token)
    ...
    public function buatPembayaranFullPending(
        ...
        $stmt = $this->db->prepare(
            ...
            'INSERT INTO pembayaran_full (id_reservasi, nominal, status, metode_pembayaran, order_id, snap_token)
    ...
    public function konfirmasiPembayaranDp(
        ...
        $stmt = $this->db->prepare(
            ...
            'UPDATE pembayaran_dp

             SET status = ?, no_transaksi = ?, metode_pembayaran = ?,

                 payment_channel = ?, midtrans_status = ?, tanggal_pembayaran = NOW()
