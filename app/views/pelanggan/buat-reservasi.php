...
<div class="reservation-container" id="reservasiWizard"
    ...
    <div class="form-section">
      ...
      <div class="form-grid">
        ...
        <div class="form-group">
          ...
          <input name="kendaraan" id="kendaraan" type="text" class="form-input"
      ...
      <div class="form-group">
        ...
        <input name="plat" id="plat" type="text" class="form-input"
  ...
  <div class="form-step" data-step="3" hidden>
    ...
    <form id="formReservasi" action="<?= BASEURL ?>/pelanggan/simpanReservasi" method="POST" class="reservation-form" style="margin-top: 0; padding-top: 0; border-top: none; box-shadow: none;">
