			...
			<div class="form-group">
				...
				<div class="service-grid" id="serviceGrid">
					<?php foreach ($layanans as $layanan):
						...
						?>
						<label class="service-item" data-layanan-id="<?= (int) $layanan['layanan_id'] ?>"
							data-motor="<?= $motorOk ? '1' : '0' ?>" data-mobil="<?= $mobilOk ? '1' : '0' ?>">
							<input type="checkbox" name="layanan_id[]" value="<?= (int) $layanan['layanan_id'] ?>"
