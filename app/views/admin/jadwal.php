			...
			<div class="admin-card jadwal-calendar-card">
				<div class="jadwal-calendar-toolbar">
					<div class="jadwal-calendar-nav">
						<a href="<?= BASEURL ?>/admin/jadwal?bulan=<?= urlencode($prevBulan) ?>" class="jadwal-nav-btn" title="Bulan sebelumnya">
							<i data-lucide="chevron-left" width="18" height="18"></i>
						</a>
						<h3 class="jadwal-calendar-title"><?= htmlspecialchars($bulanLabel) ?></h3>
						<a href="<?= BASEURL ?>/admin/jadwal?bulan=<?= urlencode($nextBulan) ?>" class="jadwal-nav-btn" title="Bulan berikutnya">
				...
				<div class="jadwal-calendar-legend">
					<span class="legend-item"><span class="legend-dot legend-upcoming"></span> Aktif / akan datang</span>
						...
						<?php foreach ($jadwalAkanDatang as $r): ?>
							...
							<div class="jadwal-list-item jadwal-list-upcoming">
								...
								<div class="jadwal-list-actions">
									...
									<button type="button" class="btn btn-detail-reservasi btn-sm" data-reservasi="<?= $reservasiJson ?>" title="Lihat detail">
